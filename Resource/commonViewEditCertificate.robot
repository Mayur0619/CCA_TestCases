...
*** Keywords ***
#************************Certificate listing and action keywords********************************
...
#************************Certificate details page keywords********************************
...
#-----------------------------------Certificate Company Name change features------------------------------------------
...
#-----------------------------------Certificate Contact feature keywords------------------------------------------
...
click on update contact button
    ...
    wait until element is visible   xpath=//li[text()='Certificate contact updated successfully']  20s